...
export const listViewCardItemSchema = z.object({
  ...
  subtitle: z
    .string()
    .optional()
    .describe("Secondary text displayed below the title"),
  media: listViewCardMediaSchema
    .optional()
    .describe("Optional media to display with the item"),
});

// Props schema
export const listViewCardSchema = z.object({
  items: z
    .array(listViewCardItemSchema)
    .default([])
  ...
  height: z
    ...
    .optional()
    .describe("Height in px or CSS value"),
  itemHeight: z
    .number()
    .optional()
    .describe("Height of each list item in pixels"),
  showCheckboxes: z
    .boolean()
    .optional()
    .describe("Show checkboxes in multi-select mode"),
  onSelect: z
    .function()
  ...
  onLoadMore: z
    ...
    .returns(
      z.promise(
        z.object({
          items: z.array(listViewCardItemSchema),
  ...
  size: z
    .enum(["sm", "md", "lg"])
    .optional()
    .describe("Size variant affecting padding and text size"),
});
...
export const ListViewCard = forwardRef<ListViewCardRef, ListViewCardProps>(
  (
    ...
    const { selectedIds, focusedIndex, searchQuery, isLoading, cursor } =
      currentState;
              ...
              {visibleItems.map((item) => {
                ...
                return (
                  <div
                    ...
                    onFocus={() =>
                      setState({ ...currentState, focusedIndex: actualIndex })
                    }
                  >
