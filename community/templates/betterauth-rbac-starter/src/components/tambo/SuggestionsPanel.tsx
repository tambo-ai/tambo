    ...
    <aside className="w-80 border-l border-white/5 bg-zinc-950/50 backdrop-blur-sm hidden lg:flex flex-col h-full">
      <div className="p-6 border-b border-white/5">
        ...
        <p className="text-xs text-zinc-500 mt-1">
          Based on your{" "}
          <span className="text-indigo-400 capitalize">{role}</span> privileges
        </p>
      </div>
      ...
      <div className="p-4 space-y-3 overflow-y-auto flex-1">
        {suggestions.map((item) => (
          ...
          >
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="text-sm text-zinc-200 group-hover:text-white font-medium">
                  {item.text}
                </p>
                <p className="text-[10px] text-zinc-500 mt-0.5 group-hover:text-zinc-400">
                  Click to ask
                </p>
              </div>
            </div>
        ...
        <div className="mt-8 p-4 rounded-xl bg-gradient-to-br from-indigo-500/10 to-purple-500/10 border border-indigo-500/20">
          <h3 className="text-xs font-semibold text-indigo-200 mb-2">
            Pro Tip
          </h3>
