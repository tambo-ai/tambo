...
import { UserCard } from "~/components/tambo/user-card";
...
import { useTamboReady } from "~/components/ClientTamboProvider";
...
>(({ className, contextKey, variant, ...props }, ref) => {
    const isTamboReady = useTamboReady();

    const { containerRef, historyPosition } = useThreadContainerContext();
    const mergedRef = useMergeRefs<HTMLDivElement | null>(ref, containerRef);

    // Guard against rendering before Tambo is ready to avoid context errors
    if (!isTamboReady) {
        return null;
    }
