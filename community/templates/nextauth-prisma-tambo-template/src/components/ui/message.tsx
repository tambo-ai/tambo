              ...
              <>
                ...
                <div className="whitespace-pre-wrap">
                  {(() => {
                    ...
                    if (React.isValidElement(associatedToolResponse.content)) {
                      return associatedToolResponse.content;
                    }
                    if (markdown) {
                      return (
                        <ReactMarkdown components={createMarkdownComponents()}>
                          {typeof getSafeContent(
                    ...
                    return getSafeContent(associatedToolResponse.content);
                  })()}
                </div>
              </>
            )}
