...
const MessageInputTextarea = ({
  ...
  return (
    <textarea
      ...
      className={cn(
        "flex-1 p-3 rounded-t-lg bg-background text-foreground resize-none text-sm min-h-[82px] max-h-[40vh] focus:outline-none placeholder:text-gray-400",
        className,
      )}
      disabled={isPending}
...
>(({ className, children, ...props }, ref) => {
  return (
    <div
      ref={ref}
      className={cn("flex justify-between items-center mt-2 p-1", className)}
