...
export const meta: MetaFunction = () => {
  return [
    ...
    {
      name: "description",
      content: "An AI-powered bookmark manager built with Remix, Supabase, and Tambo",
    },
  ];
};
      ...
      <header className="border-b border-slate-200 bg-white">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
          <div className="flex items-center gap-2">
            ...
            <span className="text-lg font-semibold text-slate-900">Bookmarks</span>
          </div>
          <Link
            to="/login"
      ...
      <main className="flex flex-1 flex-col items-center justify-center px-6 py-16">
        <div className="max-w-2xl text-center">
          ...
          <p className="mx-auto mb-8 max-w-lg text-lg text-slate-600">
            Save, organize, and discover your bookmarks with AI-powered auto-tagging. 
            Ask questions about your saved links in natural language.
          </p>
