...
export const tamboComponents: TamboComponent[] = [
  {
    ...
    propsSchema: z.object({
      ...
      species: z.string().describe('Species of the character (e.g., Human, Wookiee, Droid)'),
      ...
      forceStrength: z
        ...
        .max(10)
        .optional()
        .describe('Force power level 0-10, only for Force-sensitive characters'),
    }),
  },
  {
    name: 'StarshipCard',
  ...
  },
  {
    ...
    propsSchema: z.object({
      ...
      content: z
        .string()
        .describe('The scrolling text content - keep to 2-3 paragraphs for best effect'),
    }),
  },
];
...
export const tamboTools: TamboTool[] = [
  {
    ...
    tool: async ({ type, name }: { type: 'character' | 'starship'; name: string }) => {
      if (type === 'character') {
