  ...
  variants: {
    variant: {
      ...
      solid: [
        ...
        // Hard border (no glow)
        "[&>div]:border",
        "[&>div]:border-neutral-700",

        // Ops-style corners
        "[&>div]:rounded-md",

        // Minimal elevation
        "[&>div]:shadow-[0_2px_8px_rgba(0,0,0,0.6)]",
      ].join(" "),

      bordered: [
        "[&>div]:bg-[#101010]",
        "[&>div]:border",
        "[&>div]:border-neutral-800",
        "[&>div]:rounded-md",
      ].join(" "),
    },
  },
...
>(({ className, ...props }, ref) => {
  ...
  "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-orange-500/60 focus-visible:ring-offset-2 focus-visible:ring-offset-background",
  className,
);
