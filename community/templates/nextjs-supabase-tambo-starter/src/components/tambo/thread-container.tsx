...
>(({ className, children, disableSidebarSpacing = false, ...props }, ref) => {
  ...
  const { hasCanvasSpace, canvasIsOnLeft } =
  ...
  return (
    <div
      ...
      className={cn(
        ...
        /* Neutral ops background */
        "bg-background text-foreground",

        /* No animations, no blur, no glow */

        /* Sidebar spacing (unless disabled) */
        ...
        /* Subtle divider when canvas is present */
        hasCanvasSpace &&
          (canvasIsOnLeft
            ? "border-l border-border"
            : "border-r border-border"),

        /* Right alignment when required */
        !isLeftPanel && "ml-auto",
