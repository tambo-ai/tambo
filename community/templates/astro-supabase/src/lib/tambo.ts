...
export const components: TamboComponent[] = [
    {
        name: "DataTable",
        description: "Displays data from Supabase in a formatted table with columns and rows",
        component: DataTable,
        propsSchema: dataTableSchema,
    },
    {
        name: "Graph",
        description: "Renders interactive charts (bar, line, pie) for data visualization with customizable styling",
        component: Graph,
...
export const tools: TamboTool[] = [
    ...
    },
    {
        ...
        tool: async (params: { email: string }) => {
            ...
            if (error) throw error;
            return { success: true, message: `User with email ${params.email} deleted successfully` };
        },
    },
];
