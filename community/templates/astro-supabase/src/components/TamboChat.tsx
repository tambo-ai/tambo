        ...
        <div className="flex flex-col h-screen bg-background text-foreground animate-in fade-in duration-500">
            ...
            <div className="flex-1 overflow-y-auto px-6 py-8">
                <div className="max-w-3xl mx-auto space-y-8">
                    ...
                    {thread.messages.filter(m => (m.role as string) !== 'tool' && (m.role as string) !== 'function').map((message) => (
                        <div
                            key={message.id}
                            className={cn(
                                "flex gap-4",
            ...
            <div className="border-t border-border bg-background p-4">
                <div className="max-w-3xl mx-auto">
                    <form onSubmit={handleSubmit} className="relative flex items-end gap-2 p-2 rounded-xl border border-input bg-background focus-within:ring-1 focus-within:ring-ring">
                        <input
                            type="text"
                            value={value}
