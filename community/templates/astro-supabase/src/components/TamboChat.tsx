...
function ChatInterface({ userEmail: _userEmail }: ChatInterfaceProps) {
...
export default function TamboChat({ userToken, userEmail }: TamboChatProps) {
  return (
    <TamboProvider
