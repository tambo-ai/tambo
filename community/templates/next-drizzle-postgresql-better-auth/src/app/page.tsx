      ...
      <main className="max-w-2xl w-full space-y-8">
        <div className="flex flex-col items-center">
          ...
          <h1 className="text-4xl text-center">
            Tambo Complete Template with Better Auth & Drizzle Postgres
          </h1>
        </div>
          ...
          <div className="bg-white px-8 py-4">
            ...
            <ApiKeyCheck>
              <div className="flex gap-4 flex-wrap">
                ...
                <a
                  href="/sign-in"
                  className="px-6 py-3 rounded-md font-medium shadow-sm transition-colors text-lg mt-4 bg-white border border-gray-200 hover:bg-gray-50 text-gray-800"
                >
                  Sign In
                </a>
                <a
                  href="/sign-up"
                  className="px-6 py-3 rounded-md font-medium shadow-sm transition-colors text-lg mt-4 bg-gray-900 hover:bg-gray-800 text-white"
                >
                  Sign Up
                </a>
              </div>
