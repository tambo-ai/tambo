...
function SettingsPanelBase(props: SettingsProps) {
	...
	useEffect(() => {
		...
		if (props.name !== prevProps.name) changedFields.add("name");
		if (props.email !== prevProps.email) changedFields.add("email");
		if (props.theme !== prevProps.theme) changedFields.add("theme");
		if (props.language !== prevProps.language) changedFields.add("language");
