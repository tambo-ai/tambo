  ...
  (
    ...
    return (
      ...
      >
                ...
                return (
                  <div
                    ...
                    className={cn(
                      ...
                      sizeConfigs[validSize].padding,
                      sizeConfigs[validSize].text,
        ...
        {/* Load more indicator */}
        {isLoading && (
          <div className="absolute bottom-0 left-0 right-0 bg-white/80 backdrop-blur-sm p-2 text-center text-sm text-gray-500">
            Loading more items...
          </div>
        )}
      </div>
