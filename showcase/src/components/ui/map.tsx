...
import L, { type HeatLatLngTuple, type LatLng } from "leaflet";
import "leaflet.heat";
...
export const Map = React.forwardRef<HTMLDivElement, MapProps>(
  (
    ...
    const isGenerating =
      ...
      thread.generationStage !== "ERROR";

    // Loading/generation State
    if (!isClient) return <LoadingSpinner />;
    if (isLatestMessage && isGenerating) return <LoadingSpinner />;
    if (!center) {
      return (
        <div
          ref={ref}
      ...
      >
        ...
        >
          ...
          <MarkerClusterGroup
            ...
            iconCreateFunction={(cluster: ClusterGroup) => {
