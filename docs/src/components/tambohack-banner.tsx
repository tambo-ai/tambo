...
export function TamboHackBanner() {
  ...
  const handleDismiss = () => {
    try {
      ...
      console.warn(
        "Unable to persist dismissal state to sessionStorage",
        error,
      );
    }
    setIsVisible(false);
  ...
  const tamboHackUrl =
    process.env.NEXT_PUBLIC_TAMBOHACK_URL || "https://lu.ma/e5irqmfh";
...
export default TamboHackBanner;
