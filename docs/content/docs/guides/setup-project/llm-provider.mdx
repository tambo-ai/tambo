...
- **Skills support** - Only certain models support [skills](/concepts/skills). If you plan to use skills, choose a supported model: OpenAI GPT-5.2+ or Anthropic Claude Haiku 4.5, Sonnet 4.5+, Opus 4.5+. See the [full list](/concepts/skills#model-support).
