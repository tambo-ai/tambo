...
If your project has skills enabled but uses an unsupported model, the Skills section in your project settings shows a warning. To start using skills, see the [Manage Skills guide](/guides/manage-skills).
...
- [Manage Skills](/guides/manage-skills) - Add skills to extend your agent's capabilities
