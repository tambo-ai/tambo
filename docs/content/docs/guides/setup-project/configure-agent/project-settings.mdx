...
1. Navigate to the [Tambo Cloud dashboard](https://console.tambo.co)
...
For detailed provider configuration instructions, see [Configure LLM Provider](/docs/guides/setup-project/configure-agent/llm-provider).
...
- [Configure LLM Provider](/docs/guides/setup-project/configure-agent/llm-provider) - Detailed provider setup
- [Configure Agent Behavior](/docs/guides/setup-project/configure-agent/agent-behavior) - Practical configuration patterns
- [Add Additional Context](/docs/guides/give-context/add-user-data) - Runtime context injection
