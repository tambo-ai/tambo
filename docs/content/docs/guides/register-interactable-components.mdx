...
- **Context customization**: [Customize interactables context](/guides/customize-interactables-context) for advanced context control
- **Concepts**: [Interactable components](/concepts/generative-interfaces/interactable-components) for deeper understanding
- **API reference**: See hook documentation for `useTamboCurrentComponent` and `useCurrentInteractablesSnapshot`
