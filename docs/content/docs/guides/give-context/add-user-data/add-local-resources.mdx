...
description: Register local resources that users can reference in messages
---

import LearnMore from "@/components/learn-more";
import { BookOpen } from "lucide-react";

This guide shows you how to register local resources in your Tambo application. Resources allow users to explicitly reference documentation, files, or other content in their messages using @ mentions.
