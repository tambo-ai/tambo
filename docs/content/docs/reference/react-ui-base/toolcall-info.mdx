...
import { ToolcallInfoDemo } from "@/components/demos/toolcall-info-demo";
  ...
  return (
    <ToolcallInfo.Root message={message}>
      ...
      <ToolcallInfo.Content className="mt-2 flex flex-col gap-2 rounded-lg border border-neutral-200 bg-neutral-50 p-3 dark:border-neutral-700 dark:bg-neutral-800">
        ...
        <ToolcallInfo.Parameters className="rounded-md bg-neutral-100 p-2 font-mono text-xs dark:bg-neutral-900" />
        <ToolcallInfo.Result className="rounded-md bg-neutral-100 p-2 font-mono text-xs dark:bg-neutral-900" />
