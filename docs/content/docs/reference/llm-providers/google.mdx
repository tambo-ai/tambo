...
4. Choose your model
5. Under [**Custom LLM Parameters**](/reference/llm-providers), click **+ thinkingConfig**
...
- [Custom LLM Parameters](/reference/llm-providers) - Configure additional model parameters
