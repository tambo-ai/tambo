...
<Callout type="warning" title="Known Rendering Issues">
  ...
  encounter formatting issues. See [Labels](/reference/llm-providers/labels) for more details.
</Callout>
...
Mistral models support standard LLM parameters like temperature, max tokens, and more. Configure these in the dashboard under [**Custom LLM Parameters**](/reference/llm-providers).

For detailed information on available parameters, see [Custom LLM Parameters](/reference/llm-providers).
...
- [Custom LLM Parameters](/reference/llm-providers) - Configuring model parameters
