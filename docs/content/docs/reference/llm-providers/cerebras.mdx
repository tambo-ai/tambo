...
<Callout type="warning" title="Untested Models">
  ...
  deployment. See the [Labels](/reference/llm-providers/labels) page for more information about
  model status labels.
</Callout>
...
6. Configure any [additional parameters](/reference/llm-providers) (temperature, maxOutputTokens, etc.)
7. Click **Save** to apply the configuration

Cerebras models support the standard LLM parameters available in Tambo. For detailed parameter configuration, see [Custom LLM Parameters](/reference/llm-providers).
...
- [Custom LLM Parameters](/reference/llm-providers) - Configuring model parameters for fine-tuned responses
