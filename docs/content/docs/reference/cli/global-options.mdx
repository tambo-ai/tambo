...
## Non-Interactive and Agent-Friendly Mode {#non-interactive-mode}

The CLI automatically detects non-interactive environments (CI/CD pipelines, AI coding assistants, piped input/output) and provides helpful guidance instead of hanging on prompts. This makes it easy to use with tools like Claude Code, Cursor, and other AI-powered development environments.
