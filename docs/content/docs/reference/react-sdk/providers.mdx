...
```tsx
import { TamboContextHelpersProvider, useTamboContextHelpers } from "@tambo-ai/react";
...
```tsx
import { TamboInteractableProvider, useTamboInteractable } from "@tambo-ai/react";
