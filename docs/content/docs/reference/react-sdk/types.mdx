...
Message type for seeding new threads with system or assistant messages. Re-exported from `@tambo-ai/typescript-sdk`.
  ...
  return (
    <TamboProvider
      ...
      initialMessages={[
        ...
        { role: "assistant", content: "What would you like to cook today?" },
      ]}
    >
      <Chat />
    </TamboProvider>
