...
Component metadata returned by [`useTamboCurrentComponent`](/reference/react-sdk/hooks#ustambocurrentcomponent). Works for both AI-generated and interactable components.
