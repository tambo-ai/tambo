...
| Legacy prop                 | Current prop                | Notes                                                                                                                                                                                                                  |
| --------------------------- | --------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
This is the biggest conceptual change. Legacy messages had a simple structure — each message contained an array of `{ type: "text", text: string }` content blocks. The current SDK uses rich content blocks:
...
```tsx title="Before"
import { TamboStubProvider } from "@tambo-ai/react/legacy";
...
| Legacy (`@tambo-ai/react/legacy`) | Current (`@tambo-ai/react`)           |
| --------------------------------- | ------------------------------------- |
