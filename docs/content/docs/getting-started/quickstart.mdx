...
<Callout type="info" title="Using a coding agent?">
Install the [Tambo skill](/guides/coding-agent-skills) and ask your agent to build a demo — it's the fastest way to get a working generative UI:

```bash
npx skills add tambo-ai/tambo
```

Then prompt: "Create a Tambo app with a weather dashboard component." Works with Claude Code, Cursor, Codex, Cline, Windsurf, and 35+ other agents.
...
<Callout type="info">
  ...
  For Expo/React Native, use `--template=expo`. See [Expo Mobile
  App](/examples-and-templates/expo-mobile-app).
</Callout>
