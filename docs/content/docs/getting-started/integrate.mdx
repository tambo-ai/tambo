...
For Expo, the registry components (DOM + Tailwind) won't work in React Native. Use `@tambo-ai/react` hooks directly to build your native UI. See the [Expo template](https://github.com/tambo-ai/demo-mobile-log) for a complete example.
