...
If you prefer manual setup, you can run `npx tambo init` which will just get you set up with an API key. If you don't have an account yet, <a href="https://tambo.co/dashboard" className="text-foreground underline hover:text-foreground/80 font-medium">sign up for free</a> first.
