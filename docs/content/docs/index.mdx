...
Tambo is an open-source toolkit for building AI-powered React apps. It works with Next.js, Vite, Expo, and any React framework. Register your components, and the agent decides which one to render based on user messages.
