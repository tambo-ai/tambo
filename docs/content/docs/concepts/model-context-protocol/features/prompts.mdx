...
_[Screenshot placeholder: Shows the document button in the message input and the dropdown menu with available prompts]_
...
- **[Server-side MCP](/concepts/model-context-protocol/serverside-mcp-connection)** - ✅ Fully supported
- **[Client-side MCP](/concepts/model-context-protocol/clientside-mcp-connection)** - ✅ Fully supported
...
<LearnMore
  ...
  href="/concepts/model-context-protocol/clientside-mcp-connection"
/>

<LearnMore
  title="Server-side MCP Connections"
  description="Configure MCP servers through the Tambo dashboard"
  href="/concepts/model-context-protocol/serverside-mcp-connection"
/>
