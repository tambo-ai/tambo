...
## Staging Context for Next Message

### Context Attachments

Context attachments allow you to stage context pieces that will be automatically included in the next user message. They are automatically registered as context helpers and cleared after submission (one-time use).

Learn more in [Context Attachments](/concepts/additional-context/context-attachments).
