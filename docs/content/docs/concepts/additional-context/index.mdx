...
### Context Attachments (Badges)

Context attachments are visual badges that appear above the message input. They provide UI feedback but do not send context to the AI. To send context, use context helpers separately.
