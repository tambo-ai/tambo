...
The `isSelectedForInteraction` field indicates whether the user has explicitly selected this component (via context attachments or @ mentions) for the AI to focus on.
