...
Skills are supported by OpenAI (GPT-5.2+) and Anthropic (Claude 4.5+) models. If your project uses an unsupported model, skills are stored but not active at inference time.

For details on how skills work, supported models, and how to manage them, see the [Skills concept page](/concepts/skills) and the [Manage Skills guide](/guides/manage-skills).
