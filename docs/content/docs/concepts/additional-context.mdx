...
For detailed instructions on configuring Context Helpers, see the [Make AI Aware of State guide](/docs/guides/give-context/make-ai-aware-of-state).
...
For detailed instructions on using Context Attachments, see the [Let Users Attach Context guide](/docs/guides/give-context/let-users-attach-context).
