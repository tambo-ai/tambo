...
For detailed instructions on configuring Context Helpers, see the [Configure Context Helpers guide](/docs/guides/add-additional-context/configure-context-helpers).
...
For detailed instructions on using Context Attachments, see the [Use Context Attachments guide](/docs/guides/add-additional-context/use-context-attachments).
