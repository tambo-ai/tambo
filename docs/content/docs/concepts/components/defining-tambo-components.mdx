...
<Callout type="info" title="Interactable Components Don't Need Registration">

This registration approach is for components that Tambo generates from scratch. If you want to pre-place components on your page and let Tambo modify them, use [Interactable Components](/concepts/components/interactable-components) instead—they register themselves automatically when mounted.
