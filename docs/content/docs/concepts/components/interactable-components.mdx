...
For each component marked as interactable using `withTamboInteractable`, behind the scenes Tambo stores a state object representing the props of the component, and registers a tool to update that object.
