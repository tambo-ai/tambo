...
Walks you through creating a Tambo project and getting your free API Key. If you don't already have an account, <a href="https://tambo.co/dashboard" className="text-foreground underline hover:text-foreground/80 font-medium">sign up for free</a> to get your API key.
