...
Walks you through creating a Tambo project and getting your free API Key. If you don't already have an account, <a href="https://app.tambo.co" className="text-secondary hover:underline font-medium">sign up for free</a> to get your API key.
