...
**Notes:** Released November 2025. Adaptive reasoning automatically adjusts thinking time, optimizing cost without sacrificing quality on complex tasks. Not yet validated on common Tambo tasks - use with caution and test in your specific context.
...
**Notes:** Released November 2025. Latest conversational variant with improved responsiveness. Defaults to minimal reasoning for speed but can be configured for deeper thinking when needed. Not yet validated on common Tambo tasks - use with caution and test in your specific context.
