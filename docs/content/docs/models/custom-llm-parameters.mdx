...
These are the parameters **supported by tambo** and **suggested for use** across all LLM providers. Users can only configure these parameters through the tambo UI - they work reliably across all supported providers:
