...
<Callout type="warning" title="Known Rendering Issues">
  ...
  instructions, similar to Gemini models. Try clarifying prompt structure if
  you encounter formatting issues. See [Labels](/models/labels) for more
  details.
</Callout>
...
### Magistral Medium 1 {#magistral-medium-1}
...
### Mistral Large 2.1 {#mistral-large-2-1}
