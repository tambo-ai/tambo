...
<Callout type="warning" title="Component Rendering Issues">
  Claude 3.5 Haiku has known issues with component rendering. It may fail to fully render components or leave them in loading states. For production applications requiring reliable component rendering, consider using [Claude 4.5 Haiku](#claude-haiku-4-5) or higher models.
</Callout>
...
- **Premium**: [Claude Opus 4.1](#claude-opus-4-1) or [Claude Sonnet 4.5](#claude-sonnet-4-5)
...
- **Maximum capability**: [Claude Opus 4.1](#claude-opus-4-1)
