...
For detailed capabilities of each provider's models, see the [Provider Reference](/docs/reference/providers).
...
Learn how to configure providers in the [Configure LLM Provider guide](/docs/guides/setup-project/configure-agent/llm-provider).
...
Learn more in [Reasoning Models](/docs/models/reasoning-models).

## Related Concepts

<Cards>
  <Card href="/docs/concepts/agent-configuration" title="Agent Configuration">
    How projects, models, and instructions combine to control agent behavior
  </Card>
  <Card href="/docs/models/labels" title="Model Labels & Status">
    Understand model testing status and known behaviors with Tambo
  </Card>
  <Card href="/docs/models/reasoning-models" title="Reasoning Models">
...
Ready to configure a model provider?

- [Configure LLM Provider](/docs/guides/setup-project/configure-agent/llm-provider) - Step-by-step provider setup
- [Configure Agent Behavior](/docs/guides/setup-project/configure-agent/agent-behavior) - Practical configuration patterns
- [Provider Reference](/docs/reference/providers) - Detailed model capabilities per provider
