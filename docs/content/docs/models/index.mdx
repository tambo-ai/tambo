...
| --- | --- | --- |
| **OpenAI** | Industry-leading models including GPT-4, GPT-5, and specialized reasoning models | General-purpose tasks, reasoning, and state-of-the-art performance |
...
<Callout type="tip" title="Multiple Providers">
  You can configure multiple providers in a single project and switch between them
  as needed. This is useful for testing different models or optimizing for
  different use cases.
</Callout>
...
<Callout type="warning" title="Streaming Considerations">
  Streaming may behave inconsistently in models other than OpenAI. We're aware of
  the issue and actively working on a fix. Please proceed with caution when using
  streaming on non-OpenAI models.
</Callout>
