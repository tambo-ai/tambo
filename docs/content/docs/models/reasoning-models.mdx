...
<Callout type="info" title="Supported Providers">
  Tambo currently supports reasoning capabilities for **OpenAI** and **Google Gemini** models.
...
- **[OpenAI Models](/models/openai#provider-specific-parameters)** - Configure `reasoningEffort` and `reasoningSummary` for GPT-5, O3, and other OpenAI reasoning models
- **[Google Models](/models/google#provider-specific-parameters)** - Configure `thinkingConfig` for Gemini 3.0 Pro, Deep Think, and other Gemini reasoning models
...
- **[OpenAI Models](/models/openai)** - GPT-5, GPT-5.1, GPT-5 Mini, GPT-5 Nano, GPT-4.1 Nano, O3, and more
- **[Google Models](/models/google)** - Gemini 3.0 Pro, Deep Think, 2.5 Pro, 2.5 Flash, and more
...
- **[OpenAI Configuration](/models/openai#provider-specific-parameters)** - Adjust `reasoningEffort` levels
- **[Google Configuration](/models/google#provider-specific-parameters)** - Optimize `thinkingBudget` values
...
- Verify you're using a supported reasoning model (see [OpenAI](/models/openai) or [Google](/models/google) model lists)
...
- **[OpenAI Models](/models/openai)** - Complete OpenAI model list and reasoning configuration
- **[Google Models](/models/google)** - Complete Google model list and thinking configuration
- **[Custom LLM Parameters](/models/custom-llm-parameters)** - General parameter configuration guide
