...
- **Completion Date (YYYY-MM-DD)**: `2026-02-27`
- **Completion Notes**: Fixed stale index.mdx links and added missing primitives; consistency-polished Demo sections across all 10 MDX pages. All validations pass.
