...
- **[tambo-cloud](./tambo-cloud/) (API/backend)**: Core APIs and services powering the platform
...
- For local API development, run the backend from the [tambo-cloud directory](./tambo-cloud/) and point the frontend to it

Refer to the backend docs in the [tambo-cloud directory](./tambo-cloud/) for environment and service setup.
...
- To change SDK behavior, propose/merge an API change in [tambo-cloud](./tambo-cloud/); after deploy, the SDK will regenerate.
- For API questions or server setup, see [tambo-cloud](./tambo-cloud/)
