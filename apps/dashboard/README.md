# @tambo-ai-cloud/dashboard

Next.js 15 dashboard for Tambo Cloud. Uses App Router, React 18, tRPC, Tailwind/Shadcn UI, and React Query. Read `apps/dashboard/AGENTS.md` for the detailed rules before touching code.
...
- `apps/dashboard/AGENTS.md` – canonical rules for this package.
