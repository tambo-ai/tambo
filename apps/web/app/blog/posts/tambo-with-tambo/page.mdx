...
Example: the [APIKeyList component](https://github.com/tambo-ai/tambo/blob/main/tambo-cloud/apps/web/components/dashboard-components/project-details/api-key-list.tsx#L26).
...
Example: Registering the [APIKeyList component](https://github.com/tambo-ai/tambo/blob/main/tambo-cloud/apps/web/components/ui/tambo/chatwithtambo/config.ts#L62).
...
This is where your backend actually hooks in. In our case, we wired in the [`generateApiKey` endpoint](https://github.com/tambo-ai/tambo/blob/main/tambo-cloud/apps/web/components/ui/tambo/chatwithtambo/tools.ts#L162). You'd do the same with your own API.
