...
import { getOAuthErrorMessage } from "@/lib/oauth-error";
...
export default async function OAuthErrorPage({
  ...
  const errorMessage = getOAuthErrorMessage(code);
    ...
    <div className="mx-auto flex min-h-[60vh] w-full max-w-2xl items-center justify-center px-6 py-12">
      <Card className="w-full">
        ...
        <CardContent className="flex flex-col gap-4">
          ...
          <p className="rounded-md bg-muted p-3 text-sm">{errorMessage}</p>
