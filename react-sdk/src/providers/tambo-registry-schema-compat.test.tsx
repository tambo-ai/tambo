...
describe("Schema Compatibility", () => {
    ...
    describe("Zod 4 object schemas for tools", () => {
      ...
      it("should register tool with Zod 4 object schema", () => {
        ...
        const tool = defineTamboTool({
          ...
          tool: jest.fn().mockResolvedValue("result"),
          toolSchema: z4.object({
            args: z4.tuple([z4.string().describe("input parameter")]),
            returns: z4.string(),
          }),
        });
  ...
  describe("Schema validation errors", () => {
    ...
    it("should reject Zod 3 z.record() in tool schema", () => {
      ...
      const tool = defineTamboTool({
        ...
        tool: jest.fn().mockResolvedValue("result"),
        toolSchema: z3.object({
          args: z3.tuple([z3.record(z3.string())]),
          returns: z3.string(),
        }),
      });
    ...
    it("should reject Zod 4 z.record() in tool schema", () => {
      ...
      const tool = defineTamboTool({
        ...
        tool: jest.fn().mockResolvedValue("result"),
        toolSchema: z4.object({
          args: z4.array(z4.record(z4.string(), z4.string())),
          returns: z4.string(),
        }),
      });
  ...
  describe("Cross-version compatibility", () => {
    ...
    it("should register tools with mixed Zod 3, Zod 4, and JSON Schema", () => {
      ...
      // Zod 4 tool (using object schema since Zod 4 has different function API)
      const zod4Tool: TamboTool = {
      ...
      // JSON Schema tool
      const jsonSchemaTool: TamboTool = {
