...
export interface TamboInteractableComponent extends Omit<
  InteractableConfig,
  "propsSchema"
> {
  id: string;
 ...
 * @example
 * ```tsx
 * <TamboInteractableComponentProvider component={{ id: "123", componentName: "MyComponent", description: "My component description" }}>
 *   <MyComponent />
