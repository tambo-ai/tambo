  ...
  describe("text content parts", () => {
    it("renders a single text part", () => {
      ...
      expect(contentElement.innerHTML).toMatchInlineSnapshot(`
        <div class="space-y-4 whitespace-normal [&amp;>*:first-child]:mt-0 [&amp;>*:last-child]:mb-0 relative rounded-3xl px-4 py-2 text-[15px] leading-relaxed transition-all duration-200 font-medium max-w-full [&amp;_p]:py-1 [&amp;_li]:list-item flex flex-col justify-start shadow-none">
          <p class="my-0">
            Hello, world!
          </p>
        </div>
